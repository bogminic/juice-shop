...
@Component({
  ...
  standalone: true,
  imports: [MatCardModule, TranslateModule, MatFormFieldModule, MatInputModule, FormsModule, ReactiveFormsModule, MatIconModule, MatTooltipModule, MatSlideToggleModule, PasswordStrengthComponent, PasswordStrengthInfoComponent, MatButtonModule]
})
